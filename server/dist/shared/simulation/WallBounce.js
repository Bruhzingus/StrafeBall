...
exports.wallBounceAllowed = wallBounceAllowed;
exports.wallBounceVelocity = wallBounceVelocity;
 ...
 */
function wallBounceAllowed(vx, vz, nx, nz, c) {
    const horizSpeed = Math.hypot(vx, vz);
    if (horizSpeed < c.minEntrySpeed)
        return false;
 ...
 */
function wallBounceVelocity(vx, vy, vz, nx, nz, c, speedScale = 1) {
