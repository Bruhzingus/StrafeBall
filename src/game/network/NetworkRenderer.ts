...
export class NetworkRenderer {
  ...
  private ensurePlayer(player: PlayerState): PlayerVisual {
    ...
    // rather than every sub-mesh. Routes to whichever shadow system is active (Competitive single
    // generator or Showcase's four roof-spot generators). Auto-unregisters when the avatar is disposed.
    registerGymShadowCaster(body);
